(function (global, factory) {
	...
	var reIsNative$2 = RegExp('^' +
	  funcToString$3.call(hasOwnProperty$3).replace(reRegExpChar$2, '\\$&')
	  .replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, '$1.*?') + '$'
	);
	...
	function baseIsNative$2(value) {
	  ...
	  var pattern = (isFunction$2(value) || isHostObject$3(value)) ? reIsNative$2 : reIsHostCtor$2;
	...
	var Symbol$4 = root$3.Symbol,
	    symToStringTag = Symbol$4 ? Symbol$4.toStringTag : undefined;
	...
	function isFunction$3(value) {
	  ...
	  return tag == funcTag$3 || tag == genTag$3 || tag == asyncTag || tag == proxyTag;
	}
	...
	var lodash_isfunction = isFunction$3;
	...
	/** Used to detect overreaching core-js shims. */
	var coreJsData$3 = root$4['__core-js_shared__'];
	...
	var reIsNative$3 = RegExp('^' +
	  funcToString$4.call(hasOwnProperty$5).replace(reRegExpChar$3, '\\$&')
	  .replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, '$1.*?') + '$'
	);
	...
	function baseIsNative$3(value) {
	  if (!isObject$4(value) || isMasked$3(value)) {
	    return false;
	  }
	  var pattern = (isFunction$4(value) || isHostObject$4(value)) ? reIsNative$3 : reIsHostCtor$3;
	...
	function isArguments$1(value) {
	  ...
	  return isArrayLikeObject$1(value) && hasOwnProperty$6.call(value, 'callee') &&
	    (!propertyIsEnumerable$1.call(value, 'callee') || objectToString$7.call(value) == argsTag$1);
	}
	...
	function isArrayLikeObject$1(value) {
	  return isObjectLike$6(value) && isArrayLike$1(value);
	}
	...
	class Context {
	  ...
	  map(data, initialValue) {
	    let _initialValue = lodash_defaults(initialValue, this.initialValue);
	    return lodash_transform(data, withContext(this), _initialValue);
	  }
	}
	...
	/** Used as a reference to the global object. */
	var root$5 = _freeGlobal || freeSelf$5 || Function('return this')();

	var _root = root$5;

	/** Built-in value references. */
	var Symbol$5 = _root.Symbol;
	...
	function isFunction$6(value) {
	  ...
	  return tag == funcTag$6 || tag == genTag$6 || tag == asyncTag$1 || tag == proxyTag$1;
	}
	...
	var reIsNative$4 = RegExp('^' +
	  funcToString$6.call(hasOwnProperty$8).replace(reRegExpChar$4, '\\$&')
	  .replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, '$1.*?') + '$'
	);
	...
	function baseIsNative$4(value) {
	  ...
	  var pattern = isFunction_1(value) ? reIsNative$4 : reIsHostCtor$4;
	  return pattern.test(_toSource(value));
	}

	var _baseIsNative = baseIsNative$4;
	...
	/* Built-in method references that are verified to be native. */
	var nativeCreate$3 = _getNative(Object, 'create');

	var _nativeCreate = nativeCreate$3;
	...
	// Add methods to `Hash`.
	Hash$3.prototype.clear = _hashClear;
	Hash$3.prototype['delete'] = _hashDelete;
	Hash$3.prototype.get = _hashGet;
	Hash$3.prototype.has = _hashHas;
	Hash$3.prototype.set = _hashSet;
	...
	var _assocIndexOf = assocIndexOf$3;
	...
	// Add methods to `ListCache`.
	ListCache$3.prototype.clear = _listCacheClear;
	ListCache$3.prototype['delete'] = _listCacheDelete;
	ListCache$3.prototype.get = _listCacheGet;
	ListCache$3.prototype.has = _listCacheHas;
	ListCache$3.prototype.set = _listCacheSet;
	...
	// Add methods to `MapCache`.
	MapCache$3.prototype.clear = _mapCacheClear;
	MapCache$3.prototype['delete'] = _mapCacheDelete;
	MapCache$3.prototype.get = _mapCacheGet;
	MapCache$3.prototype.has = _mapCacheHas;
	MapCache$3.prototype.set = _mapCacheSet;
	 ...
	 * @returns {Array} Returns the property path array.
	 */
	var stringToPath$3 = _memoizeCapped(function(string) {
	  var result = [];
	  if (string.charCodeAt(0) === 46 /* . */) {
	    result.push('');
	  }
	  string.replace(rePropName$3, function(match, number, quote, subString) {
	    result.push(quote ? subString.replace(reEscapeChar$3, '$1') : (number || match));
	  });
	  return result;
	});
	...
	function baseToString$3(value) {
	  ...
	  if (isArray_1(value)) {
	    ...
	    return _arrayMap(value, baseToString$3) + '';
	  }
	  if (isSymbol_1(value)) {
